...
public class Cipher{
  ...
  private static final String DEC_MSG = "Decrypted message is: ";
  ...
  public static void main(String []args){
    ...
    String enc_msg = encrypt(message, key);
    System.out.println(AFTER + enc_msg);
    System.out.println(DEC_MSG + decrypt(enc_msg, key));
    scan.close();
 }
   ...
   * Parameters: message - the string to decrypt
   *             key - the number of rotations for each character
   * Return Value: The decrypted message
   */
