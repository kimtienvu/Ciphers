...
# Encrypts the message according to the Caesar Cipher
...
def decrypt(message, rotation):
  ...
  for el in message:
    index = ord(el) - rotation
    decrypted_message = decrypted_message + chr(index)
...
dec_msg = decrypt(result, int(key))
...
# Tests To test encryption. Uncomment to see results
'''
test1 = "Hello World!"
key1 = 12
